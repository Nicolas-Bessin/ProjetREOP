...
\begin{itemize}
    \item On réduit la taille de l'instance avec différente méthode (voir ci-dessous) .
    \item On résout le problème pour cette sous-instance avec le solveur linéaire
    \item On re-transforme la solution obtenue en une solution du problème initial.
\end{itemize}
